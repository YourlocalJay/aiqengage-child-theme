...
describe(
	...
	function () {
		...
		it(
			'should traverse all keywords containing schemas recursively',
			function () {
		...
		describe(
			...
			function () {
				...
				it(
					'should work when an options object is provided',
					function () {
		...
		describe(
			...
			function () {
				...
				it(
					'should traverse objects with allKeys: true option',
					function () {
						// schema, jsonPtr, rootSchema, parentJsonPtr, parentKeyword, parentSchema, keyIndex
						var expectedCalls = [
				...
				it(
					'should NOT traverse objects with allKeys: false option',
					function () {
						// schema, jsonPtr, rootSchema, parentJsonPtr, parentKeyword, parentSchema, keyIndex
						var expectedCalls = [
						[schema, '', schema, undefined, undefined, undefined, undefined]
				...
				it(
					'should NOT traverse objects without allKeys option',
					function () {
						// schema, jsonPtr, rootSchema, parentJsonPtr, parentKeyword, parentSchema, keyIndex
						var expectedCalls = [
						[schema, '', schema, undefined, undefined, undefined, undefined]
				...
				it(
					'should NOT travers objects in standard keywords which value is not a schema',
					function () {
						var schema2 = {
							const: {foo: 'bar'},
							enum: ['a', 'b'],
		...
		describe(
			...
			function () {
				...
				it(
					'should traverse schema in pre-order',
					function () {
				...
				it(
					'should traverse schema in post-order',
					function () {
				...
				it(
					'should traverse schema in pre- and post-order at the same time',
					function () {
