...
class Metric_Badge_Widget extends Widget_Base {
	...
	public function get_keywords() {
		return array( 'metric', 'badge', 'stat', 'counter', 'trend', 'kpi' );
	}
	...
	protected function render() {
		...
		$badge_classes = apply_filters( 'aiq_metric_badge_classes', array( 'aiq-metric-badge' ) );
		?>
