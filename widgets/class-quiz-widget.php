...
class AIQ_Quiz_Widget extends Widget_Base {
	...
	public function get_keywords() {
		return array( 'quiz', 'test', 'interactive', 'form', 'aiqengage' );
	}

	public function get_style_depends() {
		return array( 'aiq-quiz-style' );
	}

	public function get_script_depends() {
		return array( 'aiq-quiz-script' );
	}
	...
	protected function render() {
		...
		$quiz_data = array(
			...
			'result_messages'          => isset( $settings['result_messages'] ) ? $settings['result_messages'] : array(),
			'buttons'                  => array(
