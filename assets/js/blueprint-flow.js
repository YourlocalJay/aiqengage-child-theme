/**
 * Blueprint Flow Widget JavaScript
 * 
 * @package AIQEngage
 */
...
(function($) {
    ...
    var initNodeHighlighting = function() {
        $('.aiq-blueprint-flow__node').on('mouseenter focus', function() {
    ...
    var initRoiCalculator = function() {
        $('.aiq-blueprint-flow__roi-form').each(function() {
            ...
            $form.find('.aiq-blueprint-flow__roi-input, .aiq-blueprint-flow__roi-slider').on('input change', function() {
    ...
    var updateCalculation = function($form, formulaType, customFormula) {
        ...
        $form.find('.aiq-blueprint-flow__roi-input, .aiq-blueprint-flow__roi-slider').each(function() {
