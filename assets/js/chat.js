 ...
 * @author Jason
 *
 * Suppress global variable re-declare warnings:
...
(function () {
  ...
  function initSingleChat(widget, settings) {
    ...
    const quickRepliesContainer = widget.querySelector(
      ...
      if (settings.layoutType === "floating") {
        ...
        if (!container.querySelector("#chat-description")) {
          ...
          description.textContent =
            "Interactive chat with AI assistant. Use Tab to navigate, Enter to activate buttons, Escape to close.";
        ...
        fetch(settings.apiEndpoint, {
          ...
          .then((data) => {
            ...
            if (data.response) {
              ...
              addMessage(
                "ai",
                "I received your message, but I'm not sure how to respond. Could you try rephrasing?",
              );
            }
          })
          .catch((error) => {
    ...
    function addMessage(sender, text) {
      ...
      messageEl.setAttribute(
        "aria-label",
        `Message from ${sender === "ai" ? settings.aiName : "You"}: ${text}`,
      );
      ...
      announceToScreenReader(
        `New message from ${sender === "ai" ? settings.aiName : "You"}: ${text}`,
      );
    ...
    function showQuickReplies(replies) {
      ...
      announceToScreenReader(
        `${replies.length} quick reply options available. Use arrow keys to navigate.`,
      );
    }
    ...
    function getSimulatedResponse(message) {
      ...
      if (
        ...
        lowerMessage.includes("visitors") ||
