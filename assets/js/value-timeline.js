...
(function($) {
    ...
    var ValueTimeline = {
        ...
        refresh: function($timeline) {
            if (!$timeline) {
                $('.aiq-value-timeline').each(function() {
    ...
    $(window).on('elementor/frontend/init', function() {
        if (typeof elementorFrontend !== 'undefined' && elementorFrontend.hooks) {
            elementorFrontend.hooks.addAction('frontend/element_ready/aiq_value_timeline.default', function($scope) {
                ValueTimeline.init();
            });
        }
    });
