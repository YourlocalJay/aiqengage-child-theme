...
(function () {
      ...
      (entries) => {
        entries.forEach((entry) => {
          if (entry.isIntersecting) {
            ...
            const filledStars = starsEl.querySelector(
              ".aiq-testimonial-card__stars-filled",
            );
  ...
  function initProBadges() {
    const proBadges = document.querySelectorAll(
      ".aiq-testimonial-card__pro-badge",
    );
  ...
  if (window.elementorFrontend) {
    window.elementorFrontend.hooks.addAction(
      "frontend/element_ready/aiq_testimonial_card.default",
      function () {
