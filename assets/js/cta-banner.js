// assets/js/cta-banner.js

/**
 * AIQEngage CTA Banner Widget JS
 * 
 * Handles the sticky behavior and visibility of CTA banners
 */
(function($) {
    'use strict';
    ...
    function initStickyBanners() {
        $('.aiq-cta-banner--sticky').each(function() {
            const $banner = $(this);
    ...
    function setupCloseButton($banner, bannerId, cookieExpiry) {
        $banner.find('.aiq-cta-banner__close').on('click', function() {
            $banner.removeClass('aiq-cta-banner--visible');
    ...
    function trackCTAEngagement($banner) {
        ...
        $banner.find('.aiq-cta-banner__button').on('click', function() {
